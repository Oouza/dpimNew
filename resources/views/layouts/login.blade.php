            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    ...
                    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                            เข้าสู่ระบบ สำหรับเจ้าหน้าที่ กพร.
                        </h2>
                        ...
                        <!-- <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left"> -->
                            <!-- <a href="{{url('index')}}">
                                <button type="button" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top"> -->
                                <button type="submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">
                                    เข้าสู่ระบบ
                                </button>
                            <!-- </a> -->
                            <a href="{{url('forgotPassword')}}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">ลืมรหัสผ่าน</a>
                        <!-- </div> -->
                        </center>
