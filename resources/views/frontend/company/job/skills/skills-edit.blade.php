                    ...
                    <div class="font-medium text-base">รายละเอียด</div>
                            ...
                            <div id="sub_old">
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <select name="skillsSub" id="skillsSub" class="form-control select2" onchange="sselectSub()" required>
                                            ...
                                            <option value="4" selected>ทักษะย่อย 4</option>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <select name="skillsSub2" id="skillsSub2" class="form-control select2" onchange="sselectSub()" required>
                                            <option value="" hidden>- กรุณาเลือกทักษะย่อย -</option>
                                            <option value="0">อื่นๆ</option>
                                            <option value="1">ทักษะย่อย 1</option>
                                            <option value="2">ทักษะย่อย 2</option>
                                            ...
                                            <option value="5" selected>ทักษะย่อย 5</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div id="sub_new" style="display:none;">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <input type="text" class="form-control" value="ชื่อทักษะ" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <textarea cols="55" id="skills_detail" name="skills_detail" rows="10">คำอธิบายทักษะ</textarea>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <input class="form-control box-form-ct" name="news_name" type="text" id="formFile" value="ชื่อทักษะย่อย" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-1"></div>
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <textarea cols="55" id="lavel_one" name="lavel_one" rows="10">เกณฑ์ระดับที่ 1</textarea>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-1"></div>
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <textarea cols="55" id="lavel_two" name="lavel_two" rows="10">เกณฑ์ระดับที่ 2</textarea>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-1"></div>
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <textarea cols="55" id="lavel_three" name="lavel_three" rows="10">เกณฑ์ระดับที่ 3</textarea>
                                    </div>
                                </div>
