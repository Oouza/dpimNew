  ...
  <div class="content">
            ...
            <div class="intro-y box py-10 sm:py-20 mt-5">
                ...
                <div class="px-5 mt-10">
                    <div class="font-medium text-center text-lg">เพิ่มแผนกย่อย</div>
                   
                </div>
                <form action="{{ url('company/departmentSub/add') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="font-medium text-base">รายละเอียด</div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <input class="form-control box-form-ct" name="sub" type="text" id="formFile" Placeholder="ชื่อแผนกย่อย" required>
                                </div>
                            </div>
