...
@section('content')
  ...
  <div class="content">
            ...
            <div class="intro-y box py-10 sm:py-20 mt-5">
                ...
                <form action="{{ url('company/skills/add') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="font-medium text-base">รายละเอียด</div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <select name="" id="">
                                        ...
                                        <option value="" selected> ทักษะ 1 </option>
                           ...
                           <br><br><br>
                            <center>
                                ...
                                <a href="{{url('company/skillsSub')}}" class="btn btn-warning w-50">กลับหน้าหลัก</a>
