...
<body>
    ...
    <div class="content">
        ...
        <div class="intro-y box py-10 sm:py-20 mt-5">
            ...
            <form action="{{ url('/backend/userHistury/edit/'.$user->id) }}" method="post"
                ...
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-sl ate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="title" type="text" id="title"
                                value="{{ $user->e_title }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="fname" type="text" id="fname"
                                value="{{ $user->e_fname }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="lname" type="text" id="lname"
                                value="{{ $user->e_lname }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="radio" value="2" name="work_status" @if(!empty($user->e_status) &&
                            $user->e_status == 2) checked @endif onclick="toggleDiv('work-div', true)"> ทำงาน
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" value="1" name="work_status" @if(!empty($user->e_status) &&
                            $user->e_status == 1) checked @endif onclick="toggleDiv('work-div', false)"> อิสระ
                        </div>
                    </div>
                    ...
                    <div id="work-div">
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                ...
                                <select name="type_company" id="type_company" class="form-control select2"
                                    onchange="GetTypecompany(this.value)">
                                    <option value="" hidden>- กรุณาเลือกประเภทสถานประกอบการ -</option>
                                    <option value="1"
                                        {{ (!empty($companies->FKc_typemineral) && $companies->FKc_typemineral == 1)? 'selected' : '' }}>
                                        เหมืองแร่</option>
                                    <option value="2"
                                        {{ (!empty($companies->FKc_typemineral) && $companies->FKc_typemineral == 2)? 'selected' : '' }}>
                                        โรงโม่หิน</option>
                                    <option value="3"
                                        {{ (!empty($companies->FKc_typemineral) && $companies->FKc_typemineral == 3)? 'selected' : '' }}>
                                        โรงแต่งแร่</option>
                                    <option value="4"
                                        {{ (!empty($companies->FKc_typemineral) && $companies->FKc_typemineral == 4)? 'selected' : '' }}>
                                        โรงประกอบโลหกรรม</option>
                                    <option value="5"
                                        {{ (!empty($companies->FKc_typemineral) && $companies->FKc_typemineral == 5)? 'selected' : '' }}>
                                        ผู้รับเหมางานเหมืองแร่</option>
                                    <option value="6"
                                        {{ (!empty($companies->FKc_typemineral) && $companies->FKc_typemineral == 6)? 'selected' : '' }}>
                                        อื่นๆ</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                <select name="company_name" id="company_name" class="form-control select2"
                                    ...
                                    <option value="{{ $val->c_id }}"
                                        {{ ($val->c_id == $user->FKe_company)? 'selected' : '' }}>
                                        {{ $val->c_nameCompany }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                <input class="form-control box-form-ct" name="employeeNo" type="text" id="employeeNo"
                                    Placeholder="หมายเลขพนักงาน" value="{{ $user->e_employeeNo }}" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                <select name="department" id="department" class="form-control select2"
                                    ...
                                    <option value="{{ $val->d_id }}"
                                        {{ ($val->d_id == $user->FKe_department)? 'selected' : '' }}>{{ $val->d_name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                <select name="departmentSub" id="departmentSub" class="form-control select2"
                                    onchange="Getdepartmentsub(this.value)">
                                    <option value="" hidden>- กรุณาเลือกแผนกย่อย -</option>
                                    @foreach ($departmentsub as $key => $val)
                                    <option value="{{ $val->ds_id }}"
                                        {{ ($val->ds_id == $user->FKe_departmentSub)? 'selected' : '' }}>
                                        {{ $val->ds_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                <select name="position" id="position" class="form-control select2">
                                    ...
                                    <option value="{{ $val->sp_id }}"
                                        {{ ($val->sp_id == $user->FKe_position)? 'selected' : '' }}>
                                        {{ $val->sp_nameposition }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                <select name="lavel_job" id="lavel_job" class="form-control select2">
                                    ...
                                    <option value="{{ $val->lj_id }}"
                                        {{ ($val->lj_id == $user->FKe_lavel)? 'selected' : '' }}>{{ $val->lj_name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                ...
                                <br>
                                <a href="{{ asset('public/upload/personnel/'.$user->e_credit) }}" target="_blank">
                                    <font color="blue">{{ $user->e_credit }}</font>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="job" id="job" class="form-control select2">
                                ...
                                <option value="{{ $val->gj_id }}"
                                    {{ ($val->gj_id == $user->FKe_group)? 'selected' : '' }}>{{ $val->gj_name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="email" type="text" id="email"
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="phone" type="text" id="phone"
                                value="{{ $user->e_phone }}" required>
                        </div>
                    </div>

                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> รหัสผ่าน <font color="red">*</font>
                                    </lable></b>
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="password_1" type="password" id="password_1"
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> ยืนยันรหัสผ่าน <font color="red">*
                                    </font>
                                    </lable></b>
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="password_2" type="password" id="password_2"
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="addressNO_now" type="text" id="addressNO_now"
                                value="{{ $user->addressNO_now }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="povices_now" id="povices_now" class="form-control select2"
                                onchange="provinceNow()" required>
                                <option value="" hidden>- กรุณาเลือกจังหวัด -</option>
                                @foreach($provinces as $rs)
                                <option value="{{ $rs->id }}" @if(!empty($user->FKe_province_now) &&
                                    ($user->FKe_province_now == $rs->id)) selected @endif>{{ $rs->name_th }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="aumphur_now" id="aumphur_now" class="form-control select2"
                                onchange="amphureNow()" required>
                                <option value="" hidden>- กรุณาเลือกเขต/อำเภอ -</option>
                                @foreach($amphures as $rs)
                                <option value="{{ $rs->id }}" @if(!empty($user->FKe_amphur_now) &&
                                    ($user->FKe_amphur_now == $rs->id)) selected @endif>{{ $rs->name_th }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="tumbon_now" id="tumbon_now" class="form-control select2" required>
                                ...
                                <option value="{{ $rs->id }}" @if(!empty($user->FKe_tambon_now) &&
                                    ($user->FKe_tambon_now == $rs->id)) selected @endif>{{ $rs->name_th }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="postcode_now" type="text" id="postcode_now"
                                value="{{ $user->postcode_now }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="addressNO_past" type="text"
                                id="addressNO_past" value="{{ $user->addressNO_past }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="povices_past" id="povices_past" class="form-control select2"
                                onchange="provincepast()" required>
                                <option value="" hidden>- กรุณาเลือกจังหวัด -</option>
                                @foreach($provinces as $rs)
                                <option value="{{ $rs->id }}" @if(!empty($user->FKe_province_past) &&
                                    ($user->FKe_province_past == $rs->id)) selected @endif>{{ $rs->name_th }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="aumphur_past" id="aumphur_past" class="form-control select2"
                                onchange="amphurepast()" required>
                                <option value="" hidden>- กรุณาเลือกเขต/อำเภอ -</option>
                                @foreach($amphures as $rs)
                                <option value="{{ $rs->id }}" @if(!empty($user->FKe_amphur_past) &&
                                    ($user->FKe_amphur_past == $rs->id)) selected @endif>{{ $rs->name_th }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select name="tumbon_past" id="tumbon_past" class="form-control select2" required>
                                <option value="" hidden>- กรุณาเลือกแขวง/ตำบล -</option>
                                @foreach($districts as $rs)
                                <option value="{{ $rs->id }}" @if(!empty($user->FKe_tambon_past) &&
                                    ($user->FKe_tambon_past == $rs->id)) selected @endif>{{ $rs->name_th }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="postcode_past" type="text" id="postcode_past"
                                value="{{ $user->postcode_past }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="radio" id="gender" name="gender" @if(!empty($user->e_gender) && $user->e_gender
                            == 'ชาย') checked @endif value="ชาย"> ชาย
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" @if(!empty($user->e_gender) && $user->e_gender == 'หญิง') checked @endif
                            value="หญิง"> หญิง
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> ประวัติการศึกษาลำดับที่ {{ $key+1 }}
                                    </lable></b>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select id="from_years" name="from_years[]" class="form-select rounded-10 mb-3">
                                ...
                                <option value="{{ $i-543 }}" @if(!empty($i-543) && ($i-543==$val->er_datefrom)) selected
                                    @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select id="to_years" name="to_years[]" class="form-select rounded-10 mb-3">
                                ...
                                @for($i=$date; $i>=$date_old; $i--)
                                <option value="{{ $i-543 }}" @if(!empty($i-543) && ($i-543==$val->er_dateto)) selected
                                    @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="qualifications[]" type="text"
                                id="qualifications" Placeholder="วุติที่ได้รับ" value="{{ $val->er_qualification }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="institution_names[]" type="text"
                                id="institution_names" Placeholder="ชื่อสถาบัน" value="{{ $val->er_Nameinstitution }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="qualification_credits[]" type="file"
                                id="qualification_credits">
                            <br>
                            <a href="{{ asset('public/upload/personnel/'.$val->er_credit) }}" target="_blank">
                                <font color="blue">{{ $val->er_credit }}</font>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <textarea name="education_notes[]" id="education_notes" cols="58"
                                rows="10">{!! $val->er_note !!}</textarea>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> ประวัติการศึกษาลำดับที่ 1 </lable>
                                    </b>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="qualification[]" type="text"
                                id="qualification" Placeholder="วุติที่ได้รับ" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="institution_name[]" type="text"
                                id="institution_name" Placeholder="ชื่อสถาบัน" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="qualification_credit[]" type="file"
                                id="qualification_credit" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <button id="add-form-btn" type="button"
                                class="btn btn-outline-secondary btn200 rounded-10">เพิ่มประวัติการศึกษา</button>
                        </div>
                    </div>

                    @php
                    $workhistory = DB::table('work_history')->where('FKwh_userid', $user->id)->get();
                    @endphp
                    @foreach ($workhistory as $key => $val)
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> ประวัติการทำงาน {{ $key+1 }}</lable></b>
                        </div>
                    </div>
                    <input type="hidden" id="id2s" name="id2s[]" value="{{ $val->wh_id }}" readonly>
                    <input type="hidden" class="key2s" id="key2s" name="key2s[]" value="{{ $key+1 }}" readonly>
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-1"></div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select id="fromwork_years" name="fromwork_years[]" class="form-select rounded-10 mb-3">
                                <option hidden>- ปีที่เริ่มทำงาน -</option>
                                @for($i=$date; $i>=$date_old; $i--)
                                <option value="{{ $i-543 }}" @if(!empty($i-543) && ($i-543==$val->wh_datefrom)) selected
                                    @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <select id="towork_years" name="towork_years[]" class="form-select rounded-10 mb-3">
                                <option hidden>- ปีที่สิ้นสุดการทำงาน -</option>
                                @for($i=$date; $i>=$date_old; $i--)
                                <option value="{{ $i-543 }}" @if(!empty($i-543) && ($i-543==$val->wh_dateto)) selected
                                    @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="namedepartments[]" type="text"
                                id="namedepartments" Placeholder="หน่วยงาน" value="{{ $val->wh_agencies }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="namepositions[]" type="text" id="namepositions"
                                Placeholder="ตำแหน่ง" value="{{ $val->wh_position }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="work_credits[]" type="file" id="work_credits">
                            <br>
                            <a href="{{ asset('public/upload/personnel/'.$val->wh_credit) }}" target="_blank">
                                <font color="blue">{{ $val->wh_credit }}</font>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <textarea name="job_details[]" id="job_details" cols="30" rows="10">{!! $val->wh_note !!}</textarea>
                        </div>
                    </div>
                    @endforeach

                    @if (empty($val->FKwh_employeeid) != '')
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="namedepartment[]" type="text"
                                id="namedepartment" Placeholder="หน่วยงาน" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="nameposition[]" type="text" id="nameposition"
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="work_credit[]" type="file" id="work_credit"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3"></div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <button id="add-form-btn-job" type="button"
                                class="btn btn-outline-secondary btn200 rounded-10">เพิ่มประวัติการทำงาน</button>
                        </div>
                    </div>
    ...
    <script>
        ...
        let keysformCountJob = 1;
        const keysformCountJobs = document.querySelectorAll('input[name="key2s[]"]');
        const keysValue2s = [];
        for (const elements of keysformCountJobs) {
            keysValue2s.push(elements.value);
        }
        const latestsId = keysValue2s[keysValue2s.length - 1];
        if (latestsId) {
            formCountJob = latestsId;
        } else {
            formCountJob = keysformCountJob;
        }
