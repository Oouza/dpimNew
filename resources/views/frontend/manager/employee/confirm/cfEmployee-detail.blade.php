                    ...
                    <div class="font-medium text-base">รายละเอียด</div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <select name="" id="" class="form-control box-form-ct">
                                        ...
                                        <option value="" selected>กลุ่มงาน 1</option>
                            ...
                            <div id="position">
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    ...
                                    <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                        <input class="form-control box-form-ct" name="" type="text" id="formFile" value="HR" required>
                                    </div>
                                </div>
                            </div>
                           ...
                           <br><br><br>
                            <center>
                                ...
                                <a href="{{url('manager/cfEmployee')}}" class="btn btn-warning w-50">กลับหน้าหลัก</a>
                                <a href="#" class="btn btn-success w-50">ยืนยันบุคลากร</a>
                                <button type="submit" class="btn btn-primary w-24 ml-2">แก้ไข</button>        
                                <button type="submit" class="btn btn-danger">ยกเลิกบุคลากร</button>        
