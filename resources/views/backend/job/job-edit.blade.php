...
@section('content')
  ...
  <div class="content">
            ...
            <div class="intro-y box py-10 sm:py-20 mt-5">
                ...
                <form action="{{ url('backend/job/update/'.$gj->gj_id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-sl ate-200/60 dark:border-darkmode-400">
                    <div class="font-medium text-base">รายละเอียด {{$gj->gj_id}}</div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <input class="form-control box-form-ct" name="job_id" type="text" id="formFile" value="{{$gj->gj_no}}" required>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <input class="form-control box-form-ct" name="job_name" type="text" id="formFile" value="{{$gj->gj_name}}" required>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <textarea cols="80" id="job_detail" name="job_detail" rows="10">{{$gj->gj_detail}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <select name="job_type" id="job_type" class="form-control select2" required>
                                        ...
                                        <option @if($gj->FKgj_typeJob == $rs->tj_id) selected @endif value="{{$rs->tj_id}}">{{$rs->tj_no}} {{$rs->tj_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <select name="job_lavel" id="job_lavel" class="form-control select2" required>
                                        ...
                                        <option @if($gj->FKgj_lavel == $rs->lj_id) selected @endif value="{{$rs->lj_id}}">{{$rs->lj_no}} {{$rs->lj_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
