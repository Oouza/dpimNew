  ...
  <div class="content">
            ...
            <div class="intro-y box py-10 sm:py-20 mt-5">
                ...
                <div class="px-5 mt-10">
                    <div class="font-medium text-center text-lg">เพิ่มสมรรถนะในกลุ่มตำแหน่งงาน 1</div>
                   
                </div>
                <form action="{{ url('backend/job/capacity/add') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
