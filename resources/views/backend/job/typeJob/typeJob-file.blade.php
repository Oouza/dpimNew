  ...
  <div class="content">
            ...
            <div class="intro-y box py-10 sm:py-20 mt-5">
                ...
                <div class="px-5 mt-10">
                    <div class="font-medium text-center text-lg"> เพิ่มไฟล์ข้อมูลประเภทงาน </div>
                   
                </div>
                <form action="{{ url('backend/typeJob/upload') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-sl ate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> ไฟล์ตัวอย่างข้อมูลประเภทงาน </lable></b>
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <a class="btn btn-primary" href="{{ url('public/file/typeJob_Table_header.xlsx') }}">
                                ไฟล์ตัวอย่างข้อมูลประเภทงาน
                            </a>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> ไฟล์ข้อมูลประเภทงาน </lable></b>
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input class="form-control box-form-ct" name="file_typeJob" type="file" id="formFile">
                        </div>
                    </div>
                            </div>
                            </div>
