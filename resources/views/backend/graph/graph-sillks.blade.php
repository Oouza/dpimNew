...
<script>
    ...
    xAxis: {
        categories: ['ทักษะ1', 'ทักษะ2', 'ทักษะ3', 'ทักษะ4', 'ทักษะ5']
    },
    yAxis: {
        min: 0,
        title: {
    ...
    series: [{
        name: 'จำนวนบุคลากรที่มีทักษะย่อยมากกว่า 50 %',
        data: [3, 5, 1, 13, 10]
    }, {
        name: 'จำนวนบุคลากรที่มีทักษะย่อยน้อยกว่า 50 %',
        data: [14, 8, 8, 12, 6]
    }, {
        name: 'จำนวนคนที่ยังไม่มีทักษะย่อย',
        data: [0, 2, 6, 3, 8]
    }]
});
</script>
