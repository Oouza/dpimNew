...
class BackendController extends Controller
{
    ...
    function graphCapacity(){
        return view('backend.graph-capacity');
    }

    function graphSillks(){
        return view('backend.graph-sillks');
    }

    function graphCourse(){
        return view('backend.graph-course');
    }
    
    function graphHour(){
        return view('backend.graph-hour');
    }
