...
@section('content')
  ...
  <div class="content">
            ...
            <div class="intro-y box py-10 sm:py-20 mt-5">
                ...
                <form action="{{ url('backend/setting/update/') }}" method="post" enctype="multipart/form-data" onSubmit="return checkPassword(this)">
                {{ csrf_field() }}
                    ...
                    <div class="font-medium text-base">รายละเอียด</div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <input class="form-control box-form-ct" name="admin_name" type="text" id="formFile" value="แอดมินสูงสุด" required>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                                    <input class="form-control box-form-ct" name="admin_email" type="email" id="formFile" value="admin@gmail.com" required>
                                </div>
                            </div>
